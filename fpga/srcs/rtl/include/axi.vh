`define axi_single_signal(interface_name, regular_name, in_out, width, prefix, signal_name) \
  ...
  in_out [width - 1: 0] prefix``_``signal_name
...
`define axilite_interface(interface_name, dir1, dir2, prefix) \
...
`define axilite_out_interface(interface_name, prefix) \
	`axilite_interface(interface_name, input, output, prefix)

`define axilite_in_interface(interface_name, prefix) \
	`axilite_interface(interface_name, output, input, prefix)

`define axilite_connect_interface(io_prefix, wire_prefix) \
...
`define axi_interface(interface_name, dir1, dir2, prefix, idlen) \
	`axilite_interface(interface_name, dir1, dir2, prefix), \
	...
	`axi_single_signal(interface_name, AWID, dir2, idlen, prefix, aw_bits_id), \
	...
	`axi_single_signal(interface_name, BID, dir1, idlen, prefix, b_bits_id), \
	...
	`axi_single_signal(interface_name, ARID, dir2, idlen, prefix, ar_bits_id), \
	...
	`axi_single_signal(interface_name, RID, dir1, idlen, prefix, r_bits_id) \
	/*`axi_single_signal(interface_name, RUSER, dir1, 1, prefix, r_bits_user) */

`define axi_out_interface(interface_name, prefix, idlen) \
	`axi_interface(interface_name, input, output, prefix, idlen)

`define axi_in_interface(interface_name, prefix, idlen) \
	`axi_interface(interface_name, output, input, prefix, idlen)

`define axi_connect_interface(io_prefix, wire_prefix) \
	`axilite_connect_interface(io_prefix, wire_prefix), \
