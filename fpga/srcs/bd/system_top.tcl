...
# module references:
# CacheControlPlane, CoreControlPlane, cdma_addr, i2c_switch_top, leds_mux_controller, mig_control_plane, uart_inverter, uart_inverter, xlnx_cache_pard, rocketchip_top, vc709_sfp
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_crossbar_0_M00_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_0_AXI] [get_bd_intf_pins mig_control_plane_0/M_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_pins axi_clock_converter_0/s_axi_aclk] [get_bd_pins axi_clock_converter_1/m_axi_aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins pardio_reset/slowest_sync_clk] [get_bd_pins rocketchip/uncoreclk] [get_bd_pins xlnx_cache_pard_0/ACLK]
  ...
  connect_bd_net -net mig_7series_0_c1_ui_clk [get_bd_pins CacheControlPlane_0/SYS_CLK] [get_bd_pins CoreControlPlane_0/SYS_CLK] [get_bd_pins PRMSYS/m_axi_aclk] [get_bd_pins axi_clock_converter_0/m_axi_aclk] [get_bd_pins axi_clock_converter_1/s_axi_aclk] [get_bd_pins axi_perf_mon_0/core_aclk] [get_bd_pins axi_perf_mon_0/slot_0_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins leds_mux_controller_0/clk] [get_bd_pins mig_7series_0/c1_ui_clk] [get_bd_pins mig_control_plane_0/aclk] [get_bd_pins reset_100M/slowest_sync_clk]
  ...
  connect_bd_net -net reset_100M_mb_reset [get_bd_pins CacheControlPlane_0/RST] [get_bd_pins CoreControlPlane_0/RST] [get_bd_pins reset_100M/mb_reset]
  ...
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins util_vector_logic_1/Res] [get_bd_pins xlnx_cache_pard_0/ARESETN]
