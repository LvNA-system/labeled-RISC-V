...
proc create_hier_cell_hier_uart { parentCell nameHier } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins pardcore_coreclk] [get_bd_pins axi_crossbar_arm/aclk] [get_bd_pins axi_crossbar_pardcore/aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axi_uartlite_1/s_axi_aclk] [get_bd_pins axi_uartlite_2/s_axi_aclk] [get_bd_pins axi_uartlite_3/s_axi_aclk] [get_bd_pins axi_uartlite_pardcore_0/s_axi_aclk] [get_bd_pins axi_uartlite_pardcore_1/s_axi_aclk] [get_bd_pins axi_uartlite_pardcore_2/s_axi_aclk] [get_bd_pins axi_uartlite_pardcore_3/s_axi_aclk]
...
proc create_hier_cell_hier_prm_peripheral { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M02_AXI [get_bd_intf_pins axi_interconnect_1/M02_AXI] [get_bd_intf_pins axi_jtag_v1_0_0/s_axi]
  connect_bd_intf_net -intf_net axi_interconnect_1_M03_AXI [get_bd_intf_pins axi_dma_arm/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_1/M03_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_1_M04_AXI [get_bd_intf_pins GPIO_NOHYPE_SETTINGS/S_AXI] [get_bd_intf_pins axi_interconnect_1/M04_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins pardcore_uncoreclk] [get_bd_pins GPIO_NOHYPE_SETTINGS/s_axi_aclk] [get_bd_pins axi_dma_arm/m_axi_mm2s_aclk] [get_bd_pins axi_dma_arm/m_axi_s2mm_aclk] [get_bd_pins axi_dma_arm/m_axi_sg_aclk] [get_bd_pins axi_dma_arm/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/M03_ACLK] [get_bd_pins axi_interconnect_1/M04_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_jtag_v1_0_0/s_axi_aclk] [get_bd_pins hier_slowddr/pardcore_coreclk] [get_bd_pins hier_slowddr/slowest_sync_clk] [get_bd_pins pardcore_corerst/s_axi_aclk]
  ...
  connect_bd_net -net pardcore_uncorerst_interconnect_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins axi_interconnect_1/M03_ARESETN] [get_bd_pins axi_interconnect_1/M04_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins hier_slowddr/m_axi_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins pardcore_uncorerstn] [get_bd_pins GPIO_NOHYPE_SETTINGS/s_axi_aresetn] [get_bd_pins axi_dma_arm/axi_resetn] [get_bd_pins axi_jtag_v1_0_0/s_axi_aresetn] [get_bd_pins pardcore_corerst/s_axi_aresetn]
...
proc create_hier_cell_hier_pardcore_peripheral { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_hier_pardcore_peripheral() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_hier_clkrst { parentCell nameHier } {
  ...
  connect_bd_net -net hier_prm_peripheral_Dout [get_bd_pins ext_reset_in] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins resetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins pardcore_uncorerst/ext_reset_in]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S_AXI_MEM:S_AXI_MMIO:M_AXI_DMA:M_AXI_HPM0_FPD_0} \
 ] $pardcore_uncoreclk
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports pardcore_coreclk] [get_bd_ports pardcore_uncoreclk] [get_bd_pins hier_clkrst/pardcore_uncoreclk] [get_bd_pins hier_pardcore_peripheral/pardcore_uncoreclk] [get_bd_pins hier_prm_peripheral/pardcore_uncoreclk] [get_bd_pins hier_uart/pardcore_coreclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net hier_clkrst_locked [get_bd_pins hier_clkrst/locked] [get_bd_pins hier_prm_peripheral/dcm_locked]
  connect_bd_net -net hier_dma_mm2s_introut [get_bd_pins hier_prm_peripheral/mm2s_introut] [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net hier_dma_s2mm_introut [get_bd_pins hier_prm_peripheral/s2mm_introut] [get_bd_pins xlconcat_0/In1] [get_bd_pins xlconcat_1/In1]
  ...
  connect_bd_net -net pardcore_uncorerst_interconnect_aresetn [get_bd_pins hier_clkrst/interconnect_aresetn] [get_bd_pins hier_pardcore_peripheral/ARESETN] [get_bd_pins hier_prm_peripheral/S00_ARESETN] [get_bd_pins hier_uart/aresetn]
  ...
  create_bd_addr_seg -range 0x010000000000 -offset 0x00000000 [get_bd_addr_spaces hier_pardcore_peripheral/axi_dma_pardcore/Data_SG] [get_bd_addr_segs M_AXI_DMA/Reg] SEG_M_AXI_DMA_Reg
  create_bd_addr_seg -range 0x010000000000 -offset 0x00000000 [get_bd_addr_spaces hier_pardcore_peripheral/axi_dma_pardcore/Data_MM2S] [get_bd_addr_segs M_AXI_DMA/Reg] SEG_M_AXI_DMA_Reg
  create_bd_addr_seg -range 0x010000000000 -offset 0x00000000 [get_bd_addr_spaces hier_pardcore_peripheral/axi_dma_pardcore/Data_S2MM] [get_bd_addr_segs M_AXI_DMA/Reg] SEG_M_AXI_DMA_Reg
  create_bd_addr_seg -range 0x010000000000 -offset 0x00000000 [get_bd_addr_spaces hier_pardcore_peripheral/xdma_0/M_AXI_B] [get_bd_addr_segs M_AXI_DMA/Reg] SEG_M_AXI_DMA_Reg
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x60010000 [get_bd_addr_spaces S_AXI_MMIO] [get_bd_addr_segs hier_pardcore_peripheral/axi_dma_pardcore/S_AXI_LITE/Reg] SEG_axi_dma_pardcore_Reg
  ...
  create_bd_addr_seg -range 0x10000000 -offset 0x70000000 [get_bd_addr_spaces S_AXI_MMIO] [get_bd_addr_segs hier_pardcore_peripheral/xdma_0/S_AXI_B/BAR0] SEG_xdma_0_BAR0
  create_bd_addr_seg -range 0x20000000 -offset 0x40000000 [get_bd_addr_spaces S_AXI_MMIO] [get_bd_addr_segs hier_pardcore_peripheral/xdma_0/S_AXI_LITE/CTL0] SEG_xdma_0_CTL0
