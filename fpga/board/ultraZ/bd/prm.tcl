...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR0 {28} \
  ...
  connect_bd_net -net hier_uart_interrupt [get_bd_pins hier_uart/interrupt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net hier_uart_interrupt1 [get_bd_pins hier_uart/interrupt1] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net hier_uart_interrupt2 [get_bd_pins hier_uart/interrupt2] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net hier_uart_interrupt3 [get_bd_pins hier_uart/interrupt3] [get_bd_pins xlconcat_0/In4]
